...
export const Footer = () => (
	<footer className="footer botton bg-azul-oscuro pb-5 mb-1" style={{ maxWidth: "100%" }}>
		<><div className="  rounded  p-4 mt-4">
			...
			<p className=" text-white" style={{ color: "#fff !important" }}> <a style={{ color: '#ffffff', textDecoration: 'none' }} href="https://glowing-waffle-69ggqq776xqg3xrvp-3000.app.github.dev/comp-terminos" target="_blank"> <i className="fa-solid fa-square-check fa-xs" ></i>   Términos y condiciones</a></p>
