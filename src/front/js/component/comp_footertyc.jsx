...
const Footertyc = () => {
    return (
		...
		<><div className="container bg-azul-oscuro rounded py-2 mt-4">
			...
			<p className=" text-white"> <a href="https://glowing-waffle-69ggqq776xqg3xrvp-3000.app.github.dev/comp-terminos" target="_blank"></a> <i class="fa-solid fa-square-check fa-xs" style={{ color: "#ffffff;" }}></i>   Términos y condiciones</p>
