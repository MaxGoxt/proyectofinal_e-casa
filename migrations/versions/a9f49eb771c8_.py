...
Revision ID: a9f49eb771c8
Revises: 
Create Date: 2023-11-10 16:26:06.154380
...
def upgrade():
    ...
    sa.Column('longitud', sa.String(length=30), nullable=False),
    sa.Column('latitud', sa.String(length=30), nullable=False),
